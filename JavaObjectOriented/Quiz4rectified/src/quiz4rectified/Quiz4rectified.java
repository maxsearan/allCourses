...
class TV extends Item {
    ...
    public String toString() {
        return "TV{" + "type: " + type + " name: " + super.name + " weight :" + super.weight + " diagonal=" + diagonal + '}';
    }
...
class Couch extends Item {
    ...
    @Override
    public String toString() {
        return "Couch{" + "type: " + type + " name: " + super.name + " weight : " + super.weight + "seats :" + seats;
    }
}
...
class Bed extends Item {
    ...
    public Bed(String type, String name,double weight, double width,  double height) {
        super(name, weight);
        this.type = type;
        this.width = width;
        this.height = height;
    ...
    @Override
    public String toString() {
        return "Bed{" + "type: " + type + super.name + "weight: " + " width:" + width + " height: " + height + '}';
    }
}
